...
export const contentEncryptedVaults = table(
  "content_encrypted_vaults",
  {
    ...
    mutationSerial: real("mutation_serial").notNull().default(0),
    mutationPhase: text("mutation_phase").notNull().default("open"),
    mutationKind: text("mutation_kind"),
    mutationCeremonyId: text("mutation_ceremony_id"),
    mutationBaseEpoch: real("mutation_base_epoch"),
    mutationTargetEpoch: real("mutation_target_epoch"),
    mutationManifestObjectId: text("mutation_manifest_object_id"),
    mutationManifestRevisionId: text("mutation_manifest_revision_id"),
    mutationManifestGeneration: real("mutation_manifest_generation"),
...
export const contentEncryptedVaultRotationEvidenceArtifacts = table(
  "content_encrypted_vault_rotation_evidence_artifacts",
  {
    ...
    privateBlobHandleJson: text("private_blob_handle_json"),
    privateBlobSha256: text("private_blob_sha256"),
    privateBlobByteLength: integer("private_blob_byte_length"),
    bundleSha256: text("bundle_sha256"),
    signedEntrySha256: text("signed_entry_sha256"),
    signedEntryByteLength: integer("signed_entry_byte_length"),
    recoveryWrapSha256: text("recovery_wrap_sha256"),
    recoveryWrapByteLength: integer("recovery_wrap_byte_length"),
...
export const contentEncryptedVaultMigrations = table(
  "content_encrypted_vault_migrations",
  {
    ...
    cutoverManifestObjectId: text("cutover_manifest_object_id"),
    cutoverManifestRevisionId: text("cutover_manifest_revision_id"),
    cutoverManifestCiphertextHash: text("cutover_manifest_ciphertext_hash"),
